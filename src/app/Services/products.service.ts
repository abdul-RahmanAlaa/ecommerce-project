  ...
  constructor() {
    this.productsList = [
      //cateogrys 1=> Slides 2=> Basketball 3=> Walking 4=>Football 5=> Tennis 6=> Running 7=> Lifestyle
      {
        ...
        price: 150,
        Details:
          'Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque doloremque deserunt amet, rem assumenda autem ad accusantium, placeat fugit cum dolor architecto, labore et non numquam saepe in recusandae animi aliquid. Quibusdam iste possimus error, minima labore eaque exercitationem excepturi. Illo, numquam impedit porro ea magni recusandae doloremque repellat sint temporibus nesciunt modi earum aliquam quo ipsam odit dignissimos facilis reprehenderit, fugiat rerum eaque fugit reiciendis maiores commodi. Necessitatibus tempore magni rerum, libero rem ad laudantium accusantium alias beatae repudiandae deleniti. Esse placeat assumenda a impedit recusandae molestias maxime, illo distinctio dolor sint nemo est eos ratione perferendis incidunt ipsum?',
        titelImage:
          'https://dummyimage.com/700x300/000/cccccc&text=Product+Name',
        backgroundImage:
          'https://dummyimage.com/700x300/cccccc/000&text=this+is+a+placeholder',
        image:
